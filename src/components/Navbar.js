  ...
  return (
    <nav className
      ...
      <div className
        ="container-fluid">
        <Link className
          ="navbar-brand" to="/Text-utils---React/">{props.title}</Link>
        <button className
        ...
        <div className
          ...
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <Link className="nav-link active" aria-current="page" to="/Text-utils---React/">Home</Link>
            </li>
            <li className="nav-item">
          ...
          <div className={`form-check  mx-2 form-switch text-${props.mode === 'light' ? 'dark' : 'light'}`}>
            <input className="form-check-input" type="checkbox" id="flexSwitchCheckDefault" onClick={() => { props.toggleMode('#042743') }} />
